...
urlpatterns = [
    ...
    path('<int:project_id>/keys/<int:key_id>/created/', views.api_key_created, name='key_created'),
    path('<int:project_id>/keys/<int:key_id>/revoke/', views.api_key_revoke, name='key_revoke'),
]
